...
class Scenario(object):
  ...
  def __init__(self, **kwargs):
    """
                ...
                :param int games: Number of boards to return. ie. a 3 player
                game will return 3 boards.
                :param int players: Number of players. Accepts 3-6 players.
                :param int floor: Minimum score that must be attained to include
                the game in result set.
